<?php
    ...
    if (!class_exists('AuthPlugin') || !interface_exists('iAuthPlugin'))
    {
         ...
         *
         */
        require_once '/home/writers/www/site/w/includes/AuthPlugin.php';

        /**
         * Auth Plug-in Interface
         *
         */
        require_once '/home/writers/www/site/w/extensions/iAuthPlugin.php';
    ...
    if (!class_exists('PasswordHash'))
    {
         ...
         *
         */
        require_once '/home/writers/www/site/w/extensions/PasswordHash.php';
    }
    ...
    class Auth_phpBB extends AuthPlugin implements iAuthPlugin
    {
        ...
        private function connect()
        {
            ...
            if ($this->_UseExtDatabase == true)
            {
                ...
                // Select Database
                $db_selected = mysqli_select_db($fresMySQLConnection, $this->_MySQL_Database);
            ...
            {
                // Connect to database.
                $fresMySQLConnection = mysqli_connect($GLOBALS['wgDBserver'], $GLOBALS['wgDBuser'], $GLOBALS['wgDBpassword']);
                ...
                $db_selected = mysqli_select_db($fresMySQLConnection, $GLOBALS['wgDBname']);
