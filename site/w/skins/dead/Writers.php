...
class SkinWriters extends SkinTemplate {
    ...
    function initPage( &$out ) {
        ...
        $this->skinname  = 'writers';
        $this->stylename = 'writers';
        $this->template  = 'WritersTemplate';
    }
}
 ...
 * @addtogroup Skins
 */
class WritersTemplate extends QuickTemplate {
    /**
...
<html xmlns="<?php $this->text('xhtmldefaultnamespace') ?>" <?php 
    ...
    <head>
		...
		<link rel="search" type="application/opensearchdescription+xml" title="Guild of Writers Wiki" href="http://guildofwriters.com/gowwiki.xml">
...
<?php if($this->data['body_onload'    ]) { ?>onload="<?php     $this->text('body_onload')     ?>"<?php } ?>
 class="mediawiki <?php $this->text('nsclass') ?> <?php $this->text('dir') ?> <?php $this->text('pageclass') ?>">
        <div id="gowheader">
            <a href="http://www.guildofwriters.com/" title="Board index" id="logo">
                <img src="http://www.guildofwriters.com/phpbb/styles/writers/imageset/site_logo.gif" alt="Guild of Writers" />
            </a>
        </div>
...
<?php foreach($cont as $key => $val) { ?>
                                <li id="<?php echo Sanitizer::escapeId($val['id']) ?>"<?php if ( $val['active'] ) { ?> class="active" <?php } ?>><a href="<?php echo htmlspecialchars($val['href']) ?>"<?php echo $skin->tooltipAndAccesskey($val['id']) ?>><?php echo htmlspecialchars($val['text']) ?></a></li>
<?php } ?>
                            </ul>
                        </div>
                    </div>
